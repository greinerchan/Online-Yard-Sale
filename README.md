...
1 Start the Website:
  ...
  ![Image](https://github.com/greinerchan/Online-Yard-Sale/blob/master/online_yard_sale/src/img/yarnStart.png?raw=true)
...
![Image](https://github.com/greinerchan/Online-Yard-Sale/blob/master/online_yard_sale/src/img/homepage.png?raw=true)



The second page is login page. I built this page with HTML, CSS and JavaScript.

![Image](https://github.com/greinerchan/Online-Yard-Sale/blob/master/online_yard_sale/src/img/login.png?raw=true)

JavaScript will help us to verify the Email format by using regex. 

![Image](https://github.com/greinerchan/Online-Yard-Sale/blob/master/online_yard_sale/src/img/loginVerify.png?raw=true) 
...
![Image](https://github.com/greinerchan/Online-Yard-Sale/blob/master/online_yard_sale/src/img/register.png?raw=true) 
